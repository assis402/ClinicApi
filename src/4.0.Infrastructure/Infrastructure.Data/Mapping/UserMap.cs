...
namespace Infrastructure.Data.Mapping
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.TaxNumber).IsRequired().HasMaxLength(11);
            ...
            builder.Property(u => u.ClinicalUnitId).IsRequired().HasMaxLength(10);
            ...
            builder.HasOne(u => u.ClinicalUnit).WithMany(c => c.Users).HasForeignKey(u => u.ClinicalUnitId);
